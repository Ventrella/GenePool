...
const FOOD_NUTRITION_MUTATION_RATE = 0.99; // essentially 1: makes it so newborn foodbits an be either color

const NUTRITION_OFFSET = 0.2;

// NUTRITION_OFFSET is the proportion of energy a swimbot gets from food if 
